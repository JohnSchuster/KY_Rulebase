...
EXIT /B %ERRORLEVEL%
:fail03 
echo Fail 03, Robust Copy to Tomcat 7, siebel-web-determinations, ended badly with code %ERRORLEVEL%
EXIT /B %ERRORLEVEL%
:fail04 
echo Fail 04, Robust Copy to Tomcat 7, web-determinations, ended badly with code %ERRORLEVEL%
EXIT /B %ERRORLEVEL%
